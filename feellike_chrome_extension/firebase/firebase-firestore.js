import { _registerComponent, registerVersion, _getProvider, getApp, _removeServiceInstance, SDK_VERSION } from './firebase-app.js';//'https://www.gstatic.com/firebasejs/9.9.1/firebase-app.js';
